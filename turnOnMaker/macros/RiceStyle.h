...
std::vector<TPad*> makeMultiPad(const int num){//we only have 4,6,8 options for now

	cout << "num: "<< num << endl;
	std::vector<TPad*> temp;
...
std::vector<TH1D*> loadingHistogram( TFile * file, TString hName, int Nbins ){
